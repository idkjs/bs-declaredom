...
Test.test(~name="@media discrete features") @@
(
  t => {
    let equal = (x, y, t) => t |> T.equal(Css_Media.show(x), y);
...
Test.test(~name="@media range features") @@
(
  t => {
    {
      let equal = (x, y, t) => t |> T.equal(Css_Media.show(x), y);
    ...
    Test.test(~name="@media modifiers") @@
    (
      t => {
        {
          let equal = (x, y, t) => t |> T.equal(Css_Media.show(x), y);
          ...
          t |> equal([modifier @@ `!(`print)], "@media not print");
          t
          |> equal(
        ...
        Test.test(~name="@media combinators") @@
        (
          t => {
            let equal = (x, y, t) => t |> T.equal(Css_Media.show(x), y);
